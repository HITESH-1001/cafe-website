...
//   return (
//     <section className="relative bg-[#1b120b] text-white overflow-hidden">
//       {/* Background Video */}
//       <video
...
//       <div className="relative mx-auto max-w-7xl px-4 sm:px-6 pt-10 pb-14 md:pt-16 md:pb-20">
//         <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
//           {/* Left: Heading + content */}
//           <div className="relative z-10" ref={headingRef}>
//             <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight">
...
//             <div
//               ref={carouselWrap}
//               className="relative aspect-square w-[80%] md:w-[420px] mx-auto"
//             >
//               {images.map((src, i) => (
//                 <img
//                   key={src}
